...
const translations = {
    ru: {
        ...
        'participantsPage.request.steps': '<span class="participants-request-description-line">1. Сформировать команду (3-5 чел.)</span><span class="participants-request-description-line">2. Выбрать направление из <span class="participants-request-highlight participants-request-highlight-underlined">11 номинаций</span></span><span class="participants-request-description-line">3. Подготовить тезисы и презентацию</span><span class="participants-request-description-line">4. Заполнить заявку на сайте до 01.07.2026</span><span class="participants-request-description-line">5. Пройти квалификационный отбор</span><span class="participants-request-description-line">6. Получить приглашение на очный этап в Санкт-Петербург</span>',
    ...
    en: {
        ...
        'participantsPage.request.steps': '<span class="participants-request-description-line">1. Form a team of 3 to 5 members</span><span class="participants-request-description-line">2. Choose one of the <span class="participants-request-highlight participants-request-highlight-underlined">11 categories</span></span><span class="participants-request-description-line">3. Prepare abstracts and a presentation</span><span class="participants-request-description-line">4. Submit the application on the website by 01.07.2026</span><span class="participants-request-description-line">5. Pass the qualifying selection</span><span class="participants-request-description-line">6. Receive an invitation to the in-person stage in Saint Petersburg</span>',
