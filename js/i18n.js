...
const translations = {
    ru: {
        ...
        'participantsPage.request.intro': 'К участию в Форуме-конкурсе приглашаются команды <span class="participants-request-highlight">(3-5 человек)</span>, состоящие из студентов старших курсов обучения, аспирантов и молодых учёных <span class="participants-request-highlight">(до 35 лет включительно)</span> из Российской Федерации и стран Африканского континента.',
    ...
    en: {
        ...
        'participantsPage.request.intro': 'Teams of <span class="participants-request-highlight">(3-5 participants)</span> made up of senior students, postgraduate students, and young scientists <span class="participants-request-highlight">(up to and including 35 years old)</span> from the Russian Federation and African countries are invited to take part in the Forum-Competition.',
